    ...
    return (
        ...
        >
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12">
                    <a
                        href="/Grace_Billiris_CV.pdf"
                        download
                        className="inline-flex items-center px-6 py-2 bg-secondary text-primary rounded-lg font-medium hover:bg-opacity-80 transition-colors"
                    >
